...
nome_colecao = "fusao_temp_autoarima_exp_smoothing_sktime_" + data_hora_atual.strftime("%Y-%m-%d_%H:%M")
...
# Aplicar os modelos AutoARIMA e ExponentialSmoothing às colunas de interesse
...
info_fusao = {
    "nome_fusao": "autoarima_expsmoothing_forecasting",
    "tipo_fusao": "temporal",
