...
linkage = 'ward'  # Método de ligação para calcular a distância entre os clusters
...
nome_colecao = "fusao_hier_aglom_ward_pca_" + data_hora_atual.strftime("%Y-%m-%d_%H-%M")
...
df_cluster['timestamp'] = timestamps.reset_index(drop=True)
...
info_fusao = {
    "nome_fusao": "agglomerative_ward_pca",
...
pca_path = f"E:/Git/Mestrado/src/pcas/pca_{nome_colecao}.pkl"
joblib.dump(pca, pca_path)

print("Fusão hierárquica aglomerativa ward com PCA concluída e resultados armazenados na coleção:", nome_colecao)
