...
// Broadcast address
char destination[] = "0013A20041998C4F";
...
void setup()
{
  ...
  // set RTC time
  xbee900HP.setRTCfromMeshlium(MESHLIUM_ADDRESS);
...
void loop()
{
  ...
  //frame.addSensor(SENSOR_STR, "temp:"+temperature);
  frame.addSensor(SENSOR_STR, temp);
  //frame.addSensor(SENSOR_STR, "123456789012345678901234567890");
  frame.showFrame();
