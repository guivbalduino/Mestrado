...
public:
	...
	char _mqttUsername[50];
	char _mqttPassword[50];
	uint16_t _mqttPort;
	...
	uint8_t mqttConfiguration(char mqtt_server[], char client_id[], uint16_t mqtt_port, uint8_t security, char username[], char password[]);
