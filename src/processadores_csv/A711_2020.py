...
def processar_arquivo_csv():
    caminho_arquivo = 'E:\Git\Mestrado\inmet\extraidos\INMET_SE_SP_A711_SAO CARLOS_01-01-2020_A_31-12-2020.CSV'
    """
    ...
    try:
        # Lê o arquivo CSV
        df = pd.read_csv(caminho_arquivo, skiprows=8, delimiter=';', encoding='ISO-8859-1')
        ...
        df['Data Hora'] = pd.to_datetime(df['Data'].dt.strftime('%Y-%m-%d') + ' ' + df['Hora'])
        ...
        print(f"Erro ao analisar o arquivo {caminho_arquivo}. Verifique o formato dos dados. {e}")
        return pd.DataFrame()
...
if __name__ == "__main__":
    ...
    caminho_arquivo2 = 'E:\Git\Mestrado\src\processadores_csv\____INMET_SE_SP_A711_SAO CARLOS_01-01-2020_A_31-12-2020.CSV'
    # Processa o arquivo
