...
def train_and_predict_svm(collection_name, hoje):
    ...
    base_dir = f"./previsoes/completa/SVM/{sanitize_directory_name(hoje)}/{sanitize_directory_name(collection_name)}"
...
if __name__ == "__main__":
    ...
    for collection in collections:
        train_and_predict_svm(collection, hoje)
