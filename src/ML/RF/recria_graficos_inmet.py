...
def generate_all_plots(base_dir, prediction_data, residuals_data, metrics_data):
    ...
    print(f"Todos os gráficos foram gerados e salvos no diretório: {base_dir}")

# Função principal
if __name__ == "__main__":
    # Diretório base onde estão as pastas com os dados
    main_dir = ".\previsoes\\2024\RF\\2025-04-05_14-47-17"
    
    # Iterar sobre todas as pastas que começam com "inmet"
    for folder_name in os.listdir(main_dir):
        if folder_name.startswith("inmet"):
