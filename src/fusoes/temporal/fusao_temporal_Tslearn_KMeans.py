...
# Parâmetros do algoritmo TimeSeriesKMeans
...
'''
o h5py não está instalado, o que limita alguns recursos da biblioteca tslearn. No entanto, isso não impede o funcionamento básico do tslearn para tarefas como clustering de séries temporais. Se você precisar dos recursos HDF5 oferecidos pelo tslearn, pode instalar o h5py usando o comando
'''
