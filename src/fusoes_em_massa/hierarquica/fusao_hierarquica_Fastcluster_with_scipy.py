...
def run_hier_fastcluster():
    # Parâmetros do Fastcluster
    n_clusters_options = [5, 10, 20]  # Exemplos de diferentes números de clusters
    linkage_method_options = ['ward', 'single', 'complete', 'average']  # Métodos de ligação para Fastcluster
    ...
    for n_clusters in n_clusters_options:
        for linkage_method in linkage_method_options:
            for n_components in n_components_options:
                ...
                nome_colecao = "fusao_hier_fastcluster_pca_" + data_hora_atual.strftime("%Y-%m-%d_%H-%M-%S")
                ...
                df_cluster = df_concatenado[['temperature_C', 'humidity_percent', 'pressure_hPa',"PRECIPITAÇÃO TOTAL, HORÁRIO (mm)"]].copy()
