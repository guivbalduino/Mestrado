...
pca_pasta = "./src/pcas"
dendograma_pasta = "./comparativos/hierarquicos/dendogramas"
...
# Dividir o nome da coleção para criar a pasta com base no penúltimo e no último elemento
    ...
    # Filtrar os dados para considerar apenas aqueles a partir de 01/02/2006
    df = df[df['timestamp'] >= '2006-02-01']
