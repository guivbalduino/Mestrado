...
output_base_dir = "E:/Git/Mestrado/comparativos/hierarquicos/clusters"
...
for nome_colecao in colecoes_fusao_hier:
    ...
    plt.savefig(f'{output_colecao_dir}/disp_clusters_{nome_colecao[:-3]}_2024.png')
    plt.close()
    ...
    plt.ylabel('Componente Principal 2')
    plt.legend()
    plt.savefig(f'{output_colecao_dir}/centroides_clusters_{nome_colecao[:-3]}_2024.png')
    plt.close()
    ...
    plt.savefig(f'{output_colecao_dir}/tamanho_clusters_{nome_colecao[:-3]}_2024.png')
    plt.close()
    ...
    if not ("birch" in nome_colecao or "hdbscan" in nome_colecao):
        ...
        plt.tight_layout()
        plt.savefig(f'{output_colecao_dir}/correlacao_clusters_{nome_colecao[:-3]}_2024.png')
        plt.close()
