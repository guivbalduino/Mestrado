...
# Realizar o clustering hierárquico usando Fastcluster nos dados reduzidos pelo PCA
inicio_fusao = datetime.now()
linkage_matrix = fastcluster.linkage_vector(df_pca, method=linkage_method)
cluster_labels = fcluster(linkage_matrix, t=n_clusters, criterion='maxclust')
fim_fusao = datetime.now()
tempo_fusao = fim_fusao - inicio_fusao

# Adicionar rótulos de cluster ao DataFrame original
df_concatenado['cluster_label'] = cluster_labels
